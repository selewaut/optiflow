import pytest
from optiflow.baseline.single_echelon_models._eoq_stochastic import EOQStochastic
...
def test_reorder_point(ordering_cost, holding_cost, demand_distribution, n_periods,service_level ,mean, std, expected_reorder_point):
    model = EOQStochastic(ordering_cost=ordering_cost, holding_cost=holding_cost, demand_distribution=demand_distribution, n_periods=n_periods, service_level=service_level, loc=mean, scale=std)
...
def test_expected_service_level(ordering_cost, holding_cost, demand_distribution, n_periods, initial_inventory,mean, std, expected_service_level):
    model = EOQStochastic(ordering_cost=ordering_cost, holding_cost=holding_cost, demand_distribution=demand_distribution, n_periods=n_periods, initial_inventory=initial_inventory, loc=mean, scale=std)
